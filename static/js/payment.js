...
// Function to create dots, curly ribbons, and party poppers dynamically
function createConfettiAndRibbons() {
    // Create 40 confetti dots
    for (let i = 0; i < 40; i++) {
    ...
    // Create 6 dynamic party popper ribbons
    for (let i = 0; i < 6; i++) {
        const ribbon = document.createElement('div');
        ribbon.classList.add('party-popper');

        // Random position, rotation, and animation
        ribbon.style.left = Math.random() * 100 + 'vw';
        ribbon.style.top = '-10vh';
        ribbon.style.animationDelay = Math.random() * 2 + 's';
        ribbon.style.animationDuration = Math.random() * 3 + 5 + 's';
...
// Generate confetti and ribbons continuously
createConfettiAndRibbons();
setInterval(createConfettiAndRibbons, 4000);
